...
import { ResidueTypeChipComponent } from '../../../../../../trash/residues/components/residue-type-chip/residue-type-chip-component';
...
export class TruckCardComponent {
  ...
  public async handleClick() {
    await this.router.navigate(['plant', 'trucks', this.truck().id]);
  }
